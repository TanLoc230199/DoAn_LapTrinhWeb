<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="CapNhatMaLoai.aspx.cs" Inherits="WEB_BanSach.Admin.CapNhatMaLoai" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="khungNCC">
        ...
        <div align="center">
            ...
            &nbsp;&nbsp;
            <asp:Button ID="btnSua" runat="server" OnClick="Button2_Click" Text="Sửa" Width="60px" Height="28px" />
            &nbsp;&nbsp;
